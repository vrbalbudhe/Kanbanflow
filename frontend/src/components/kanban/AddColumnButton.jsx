...
const AddColumnButton = () => {
  ...
  return (
    <button
      ...
      className="w-full md:w-[450px] p-5 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-blue-400 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200 flex items-center justify-center gap-2 bg-white/50 backdrop-blur-sm"
    >
      <svg
        className="w-8 h-8"
        fill="none"
